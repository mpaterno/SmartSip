...
public class healthStatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFinishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Utils.saveSharedSetting(healthStatsActivity.this, MainActivity.PREF_USER_FIRST_TIME, "false");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_health_stats, menu);
        return true;
    }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            enterButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //currentUser.create(userNameStr);
                }
            });
